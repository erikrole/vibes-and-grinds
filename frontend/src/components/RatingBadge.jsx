...
export default function RatingBadge({ rating, label, maxRating = 10 }) {
  ...
  return (
    <div className="flex flex-col items-center flex-1 max-w-[120px]">
      ...
      <div
        className="w-full px-4 py-3 rounded-md font-black text-2xl flex items-center justify-center border border-stone-200 dark:border-stone-700 rating-number min-w-[75px]"
        style={{
